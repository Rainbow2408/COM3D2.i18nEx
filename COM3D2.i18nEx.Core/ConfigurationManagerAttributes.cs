...
namespace COM3D2.i18nEx.Core
{
    ...
    ///
    /// Usage:
    /// This class template has to be copied inside the plugin's project and referenced in PluginInfo.cs.
    /// make an instance of it and assign any fields that you want to override.
    /// </summary>
    internal sealed class ConfigurationManagerAttributes
    {
        ...
        /// <summary>
        /// Custom setting editor for KeyboardShortcut settings (OnGUI code that replaces the default editor provided by ConfigurationManager).
        /// See below for a deeper explanation. Using a custom drawer will cause many of the other fields to do nothing.
        /// </summary>
        public System.Action<BepInEx.Configuration.ConfigEntryBase> CustomHotkeyDrawer;
